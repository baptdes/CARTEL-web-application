package cartel.spring_boot_api.service.impl;
...
public class ItemCopyServiceImpl implements ItemCopyService {
    ...
    @Override
    public ItemCopy createItemCopy(String itemId) {
        Item item = itemRepository.findById(itemId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, 
                    "Item not found with ID: " + itemId));
        ItemCopy newCopy = new ItemCopy(item);
        return itemCopyRepository.save(newCopy);
    }

    @Override
    public Optional<ItemCopy> getItemCopyById(Long copyId) {
    ...
    @Override
    public Page<ItemCopy> searchItemCopiesByItemName(String itemName, int pageNumber, int pageSize, boolean asc, String sortBy) {
    ...
    @Override
    public Page<ItemCopy> getAllItemCopies(int pageNumber, int pageSize, boolean asc, String sortBy) {
        Pageable pageable = asc ?
                PageRequest.of(pageNumber, pageSize, Sort.by(sortBy)) :
                PageRequest.of(pageNumber, pageSize, Sort.by(sortBy).descending());
